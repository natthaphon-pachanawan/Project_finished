    ...
    <div class="container">
        ...
        <form id="activity-form" action="{{ route('acg.update', ['id' => $activity->ID_ACG]) }}" method="POST">
            ...
            <div>
                ...
                <input type="text" id="Name_Elderly" name="Name_Elderly" value="{{ $activity->caregiver->Name_Elderly }}" readonly>
            </div>
            <div>
                <label for="activity_date">กิจกรรมการดูแลผู้สูงอายุ</label>
                <input type="date" id="activity_date" name="activity_date" value="{{ $activity->Date_ACG }}" required>
            </div>

            <h4>กิจกรรมด้านสาธารณสุข</h4>
            <div>
                <label for="evaluate">ประเมิน/ติดตามอาการ</label>
                <input type="text" id="evaluate" name="evaluate" value="{{ $activity->Evaluate }}">
            </div>
            <div>
            ...
            <div>
                ...
                <input type="text" id="other_specified" name="other_specified" value="{{ $activity->Other }}">
            </div>
            ...
            <div>
                ...
                <input type="text" id="other_social_specified" name="other_social_specified" value="{{ $activity->Other_specified }}">
            </div>

            <div>
                <label for="problems_found">ปัญหาที่พบ</label>
                <textarea id="problems_found" name="problems_found" rows="5">{{ $activity->Problem }}</textarea>
            </div>
            <div>
