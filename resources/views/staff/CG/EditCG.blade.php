    ...
    <div class="container">
        ...
        <form id="caregiver-form" action="javascript:void(0);" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" id="Name_CG" name="Name_CG" class="form-control" value="{{ $caregiver->Name_CG }}" required>
            </div>
            <div class="form-group">
                <label for="Name_Elderly">ชื่อ-สกุลผู้สูงอายุ</label>
                <input type="text" id="Name_Elderly" name="Name_Elderly" class="form-control" value="{{ $caregiver->Name_Elderly }}" readonly>
                <input type="hidden" id="ID_Elderly" name="ID_Elderly" value="{{ $caregiver->ID_Elderly }}">
            </div>
            <div class="form-group">
                <label for="Age">อายุ</label>
                <input type="number" id="Age" name="Age" class="form-control" value="{{ $caregiver->Age }}" required readonly>
            </div>
            <div class="form-group">
                <label for="Address">ที่อยู่</label>
                <input type="text" id="Address" name="Address" class="form-control" value="{{ $caregiver->Address }}" required readonly>
            </div>
            <div class="form-group">
                <label for="Weight">น้ำหนักตัว</label>
                <input type="number" id="Weight" name="Weight" class="form-control" step="0.1" value="{{ $caregiver->Weight }}" required>
            </div>
            <div class="form-group">
                <label for="Height">ส่วนสูง</label>
                <input type="number" id="Height" name="Height" class="form-control" step="0.1" value="{{ $caregiver->Height }}" required>
            </div>
            <div class="form-group">
                <label for="Waist">รอบเอว</label>
                <input type="number" id="Waist" name="Waist" class="form-control" step="0.1" value="{{ $caregiver->Waist }}" required>
            </div>
            <div class="form-group">
                <label for="Group_ADL">ประเภทผู้สูงอายุ</label>
                <input type="text" id="Group_ADL" name="Group_ADL" class="form-control" value="{{ $caregiver->Group_ADL }}" readonly required>
            </div>
            <div class="form-group">
                <label for="Disease">โรคประจำตัว</label>
                <input type="text" id="Disease" name="Disease" class="form-control" value="{{ $caregiver->Disease }}">
            </div>
            <div class="form-group">
                <label for="Disability">ความพิการ</label>
                <input type="text" id="Disability" name="Disability" class="form-control" value="{{ $caregiver->Disability }}">
            </div>
            <div class="form-group">
                <label for="Rights">สิทธิการรักษา</label>
                <input type="text" id="Rights" name="Rights" class="form-control" value="{{ $caregiver->Rights }}">
            </div>
            <div class="form-group">
                <label for="Caretaker">ชื่อ-สกุลผู้ดูแล</label>
                <input type="text" id="Caretaker" name="Caretaker" class="form-control" value="{{ $caregiver->Caretaker }}" required>
            </div>
            <div class="form-group">
                <label for="Related">เกี่ยวข้องเป็น</label>
                <input type="text" id="Related" name="Related" class="form-control" value="{{ $caregiver->Related }}" required>
            </div>
            <div class="form-group">
                <label for="Phone_Caretaker">เบอร์ติดต่อ</label>
                <input type="text" id="Phone_Caretaker" name="Phone_Caretaker" class="form-control" value="{{ $caregiver->Phone_Caretaker }}" required>
            </div>
        ...
        <form id="assessment-form" class="hidden" action="{{ route('cg.update', $caregiver->ID_CG) }}" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="date" id="Date" name="Date" class="form-control" value="{{ $caregiver->Date_CG }}" required>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="text" id="Vital_signs" name="Vital_signs" class="form-control" value="{{ $caregiver->Vital_signs }}" required placeholder="BP… PR… RR…. BT…">
            </div>
            <div class="form-group">
                ...
                <input type="text" id="Bedsores_details" name="Bedsores_details" class="form-control" value="{{ $caregiver->Bedsores_details }}" placeholder="รายละเอียดถ้ามี">
            </div>
            <div class="form-group">
                ...
                <input type="text" id="Pain_details" name="Pain_details" class="form-control" value="{{ $caregiver->Pain_details }}" placeholder="รายละเอียดถ้ามี">
            </div>
            <div class="form-group">
                ...
                <input type="text" id="Swelling_details" name="Swelling_details" class="form-control" value="{{ $caregiver->Swelling_details }}" placeholder="รายละเอียดถ้ามี">
            </div>
            <div class="form-group">
                ...
                <input type="text" id="Itchy_rash_details" name="Itchy_rash_details" class="form-control" value="{{ $caregiver->Itchy_rash_details }}" placeholder="รายละเอียดถ้ามี">
            </div>
            <div class="form-group">
                ...
                <input type="text" id="Stiff_joints_details" name="Stiff_joints_details" class="form-control" value="{{ $caregiver->Stiff_joints_details }}" placeholder="รายละเอียดถ้ามี">
            </div>
            <div class="form-group">
                ...
                <input type="text" id="Malnutrition_details" name="Malnutrition_details" class="form-control" value="{{ $caregiver->Malnutrition_details }}" placeholder="รายละเอียดถ้ามี">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="text" id="Economic_problems_details" name="Economic_problems_details" class="form-control" value="{{ $caregiver->Economic_problems_details }}" placeholder="รายละเอียดถ้ามี">
            </div>
            <div class="form-group">
                ...
                <input type="text" id="Social_problems_details" name="Social_problems_details" class="form-control" value="{{ $caregiver->Social_problems_details }}" placeholder="รายละเอียดถ้ามี">
            </div>
            <div class="form-group">
                ...
                <input type="text" id="Doctor_FU_details" name="Doctor_FU_details" class="form-control" value="{{ $caregiver->Doctor_FU_details }}" placeholder="รายละเอียดถ้ามี">
            </div>
            <div class="form-group">
                <label for="Other_problems">ปัญหาอื่น ๆ</label>
                <input type="text" id="Other_problems" name="Other_problems" class="form-control" value="{{ $caregiver->Other_problems }}">
            </div>
            <div class="form-group">
                <label for="Assistance">การช่วยเหลือ</label>
                <input type="text" id="Assistance" name="Assistance" class="form-control" value="{{ $caregiver->Assistance }}">
            </div>
            <div class="form-group">
