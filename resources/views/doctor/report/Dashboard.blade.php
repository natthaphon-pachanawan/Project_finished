...
<body>
    ...
    <div class="container">
        ...
        <form class="search-form">
            ...
            <button type="button" class="btn btn-primary" onclick="clearSearch()">ล้าง</button>
        </form>
...
<script>
    ...
    function printRecommendations() {
        ...
        newWindow.document.write('<html><head><title>แนะนำการดูแล</title></head><body>');
    newWindow.document.write('<h2>สำหรับ ' + elderlyName + '</h2>');
    newWindow.document.write('<p><strong>วันเกิด:</strong> ' + $('#elderlyBirthday').text() + '</p>');
    newWindow.document.write('<p><strong>น้ำหนัก:</strong> ' + $('#elderlyWeight').text() + '</p>');
    newWindow.document.write('<p><strong>ที่อยู่:</strong> ' + $('#elderlyAddress').text() + '</p>');
    newWindow.document.write('<p><strong>ข้อมูล ADL:</strong> ' + $('#elderlyADL').text() + '</p>');
    newWindow.document.write('<pre>' + textToPrint + '</pre>');
